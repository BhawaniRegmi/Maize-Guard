...
import 'package:makai_raksha/feedback_page.dart';
import 'package:makai_raksha/login_page.dart';
      ...
      drawer: Drawer(
        child: ListView(
          children: [
            ...
            ListTile(
              title: Text(
                'मकै_रक्षक मकै बाली रोग पहिचान अनुप्रयोगमा स्वागत छ',
            ...
            ListTile(
              ...
              subtitle: Text(
                " तपाईंको मकै बिरुवाको तस्बिर यस अनुप्रयोगमा अपलोड गर्नुहोस्, र यो तस्विर पहिचान प्रविधिलाई प्रयोग गरी उपस्थित कुनै रोगहरूको पूर्वानुमान गर्दछ, उनीहरूको विश्वास स्तरसहित। ",
        ...
        child: Center(
          ...
          children: [
            ...
            ElevatedButton(
              ...
              child: Text('रोग पूर्वानुमान गर्नुहोस्',
                  style: TextStyle(fontSize: 20.0)),
              style: ElevatedButton.styleFrom(
                backgroundColor: Colors.white,
                shape: RoundedRectangleBorder(
